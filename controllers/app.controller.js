...
const assId = "asst_YgTFhZOT0ERaGcvBXZf3cavE"
const threadId ="thread_BxrCXnanw4V3sYVKUZenzuhE"
...
export const generateAssistant=async (req,res)=>{
    try{
        const myAssistant = await openai.beta.assistants.create({
            instructions:
            `you will receive a product description,title and product bullet points, you could get all three, just  or just one of them, if you receive none, please reply with "You did not enter any values" to be used on the amazon website for specific products, you have to make sure that these value adheres to the given rules I'm about to give you, you will be returning a fixed version of that description and pointing out the errors in bullet points, the given description will be in the format:
