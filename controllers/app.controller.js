...
export const asin = async (req, res) => {
    try {
        ...
        res.status(200).json({ success: true, title:result.title, description:result.description, bullets:result.features, category:result.categoryTree[0].name,  message:"Values Filled in Successfully."});
    } catch (error) {
        console.log(error)
